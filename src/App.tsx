...
import { Download, FileText, Trash2, Plus, Sun, Moon, Calculator, DollarSign, Smartphone, Wifi, Sparkles, Zap } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 dark:from-black dark:via-purple-950 dark:to-black relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-40 left-1/3 w-80 h-80 bg-pink-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "2s" }}></div>
        
        {/* Grid Pattern */}
        <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,.02)_1px,transparent_1px)] bg-[size:100px_100px]"></div>
        
        {/* Radial Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-radial from-transparent via-purple-900/20 to-black/40"></div>
      </div>
      ...
      <div className="relative container mx-auto px-4 py-8 lg:py-12">
        ...
        >
          ...
          >
            {/* Glow Effect */}
            <div className="absolute -inset-1 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 rounded-3xl blur opacity-30 group-hover:opacity-60 transition duration-1000"></div>
            
            {/* Main Header Card */}
            <div className="relative bg-gradient-to-br from-white/10 via-white/5 to-white/10 backdrop-blur-2xl border border-white/20 rounded-3xl p-8 shadow-2xl">
              {/* Floating Elements */}
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <motion.h1 
                      ...
                      className="text-5xl lg:text-6xl font-black bg-gradient-to-r from-white via-purple-200 to-pink-200 bg-clip-text text-transparent"
                    >
                      {APP_NAME}
                    </motion.h1>
                    <motion.p 
                ...
                <div className="flex items-center gap-4 flex-wrap">
                  {showInstallPrompt && (
                    <motion.button
                      ...
                      className="px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-2xl font-bold shadow-lg text-sm border border-green-400/30"
                    >
                  ...
                  <motion.button
                    ...
                    className={`px-6 py-3 rounded-2xl transition-all duration-300 font-bold shadow-lg border ${
                      showAdvancedMode 
                        ? 'bg-gradient-to-r from-purple-600 to-pink-600 text-white border-purple-400/30' 
                        : 'bg-white/10 text-white hover:bg-white/20 border-white/20'
                    }`}
                  >
                    {showAdvancedMode ? <Sparkles className="w-4 h-4 inline mr-2" /> : <Zap className="w-4 h-4 inline mr-2" />}
                  ...
                  >
                    {dark ? <Sun className="w-6 h-6 text-yellow-400" /> : <Moon className="w-6 h-6 text-blue-400" />}
                  </motion.button>
                </div>
              </div>
            </div>
